...
# Creating While loop to check set alarm is passed or not:
...
time_format=Label(clock, text= "Enter time in 24 hour format!", fg="red",bg="black",font="Calibri").place(x=60,y=120)
